			...
			<section className="w-full">
				<Wrapper>
					<RowView justify="between" align="center" className="h-full py-3">
						<RowView align="center" className="gap-1 sm:gap-2">
							<div className="relative size-19 sm:size-20 md:size-30 border-2 border-white rounded-full bg-primary -mt-10 md:-mt-20">
								<Image src={"/Logo.webp"} alt="logo" fill priority className="object-contain" />
							</div>
							<h1 className="font-poppins font-semibold text-foreground/80 text-xl sm:text-[1.4rem] md:text-3xl">
								The Butters
							</h1>
						</RowView>
						<RowView className="gap-2 md:gap-4 text-extra-orange">
							<RowView align="center" className={cn(customer && "gap-2")}>
								<p className="sm:text-lg text-center">{customer ? customer.nome : ""}</p>
								<Link
