					...
					<div className="px-8 py-10">
						...
						>
							...
							>
								...
								<h3 className="font-semibold text-lg text-foreground/80">Administração</h3>
							...
							>
								...
								<h3 className="font-semibold text-lg text-foreground/80">Balcão</h3>
								<p className="text-sm text-foreground/70 mt-1">
									Acesso rápido ao sistema de atendimento do balcão.
								</p>
							</Link>
							...
							>
								...
								<h3 className="font-semibold text-lg text-foreground/80">Pedidos</h3>
								<p className="text-sm text-foreground/70 mt-1">
									Visualize, acompanhe e gerencie pedidos em tempo real.
								</p>
							</Link>
						</div>
					</div>
